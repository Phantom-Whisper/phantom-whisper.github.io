                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    <div className="z-10">
                        ...
                        <p className="subtext">
                            ...
                            skills to deliver dynamic softwares and applications.
                        </p>
                    </div>
                    <div className="absolute inset-x-0 pointer-evets-none -bottom-4 h-1/2 sm:h-1/3 bg-gradient-to-t from-blackPearl to-indigo" />
                </div>
                {/* Grid 2 */}
